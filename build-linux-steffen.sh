...
echo $exports
com="./vcpkg/vcpkg export $exports  --host-triplet=$VCPKG_DEFAULT_TRIPLET --triplet=$VCPKG_DEFAULT_TRIPLET --overlay-triplets=./ --raw --output-dir=$outputDir --output=$outputFileName"
echo "$com"
eval $com
